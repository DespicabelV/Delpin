...
namespace Delpin {
    ...
    public partial class delpinasDataSet2 : global::System.Data.DataSet {
        ...
        public partial class ResDataTable : global::System.Data.TypedTableBase<ResRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ResRow AddResRow(int resnr, int pris, string navn) {
...
namespace Delpin.delpinasDataSet2TableAdapters {
    ...
    public partial class ResTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Res] WHERE (([resnr] = @Original_resnr) AND ((@IsNull_pris = 1" +
                " AND [pris] IS NULL) OR ([pris] = @Original_pris)) AND ((@IsNull_navn = 1 AND [n" +
                "avn] IS NULL) OR ([navn] = @Original_navn)))";
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Res] ([resnr], [pris], [navn]) VALUES (@resnr, @pris, @navn);\r" +
                "\nSELECT resnr, pris, navn FROM Res WHERE (resnr = @resnr)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Res] SET [resnr] = @resnr, [pris] = @pris, [navn] = @navn WHERE (([resnr] = @Original_resnr) AND ((@IsNull_pris = 1 AND [pris] IS NULL) OR ([pris] = @Original_pris)) AND ((@IsNull_navn = 1 AND [navn] IS NULL) OR ([navn] = @Original_navn)));
SELECT resnr, pris, navn FROM Res WHERE (resnr = @resnr)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT resnr, pris, navn FROM dbo.Res";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(delpinasDataSet2.ResDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual delpinasDataSet2.ResDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            delpinasDataSet2.ResDataTable dataTable = new delpinasDataSet2.ResDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(delpinasDataSet2.ResDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        public virtual int Delete(int Original_resnr, global::System.Nullable<int> Original_pris, string Original_navn) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int resnr, global::System.Nullable<int> pris, string navn) {
        ...
        public virtual int Update(int resnr, global::System.Nullable<int> pris, string navn, int Original_resnr, global::System.Nullable<int> Original_pris, string Original_navn) {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Original_resnr));
            if ((Original_pris.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[4].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_pris.Value));
            }
            else {
            ...
            if ((Original_navn == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_navn));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<int> pris, string navn, int Original_resnr, global::System.Nullable<int> Original_pris, string Original_navn) {
            return this.Update(Original_resnr, pris, navn, Original_resnr, Original_pris, Original_navn);
        }
    }
